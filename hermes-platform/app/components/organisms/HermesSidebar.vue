    ...
    <nav class="sidebar-nav">
      ...
      >
        <template #icon>
          ...
          <!-- Career: Rocket -->
          <svg v-else-if="item.icon === 'career'" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
          ...
          <svg v-else-if="item.icon === 'knowledge'" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
